...
const SCENARIOS = {
  ...
  token_buyback_fair: { engine: 'token_buyback' },
  token_buyback_overvalued: {
    engine: 'token_buyback', unlockAllocationShare: 0.20, tokenPriceUsd: 0.25,
    commerceAttachRate: 0.04, commerceAovUsd: 110, commerceTakeRate: 0.10,
    subConversion: 0.12, subPriceUsd: 7.99, adArpuUsd: 1.20, offerArpuUsd: 0.50,
    earnerShare: 0.30, coveredShare: 0.60, payerPepmUsd: 8.00,
    churnCeiling: 0.18, prizeMultiplier: 2.2,
    paidSignupsM1: 14000, paidSignupDecay: 0.985, referralK: 0.10,
  },
  token_buyback_sized: {
    engine: 'token_buyback', unlockAllocationShare: 0.20, tokenPriceUsd: 0.002,
    commerceAttachRate: 0.04, commerceAovUsd: 110, commerceTakeRate: 0.10,
    subConversion: 0.12, subPriceUsd: 7.99, adArpuUsd: 1.20, offerArpuUsd: 0.50,
    earnerShare: 0.30, coveredShare: 0.60, payerPepmUsd: 8.00,
    churnCeiling: 0.18, prizeMultiplier: 2.2,
  ...
  token_buyback_emission: {
    engine: 'token_buyback', unlockAllocationShare: 0.20, tokenPriceUsd: 0.002,
    emissionMultipleOfBuyback: 0.50,
    commerceAttachRate: 0.04, commerceAovUsd: 110, commerceTakeRate: 0.10,
    subConversion: 0.12, subPriceUsd: 7.99, adArpuUsd: 1.20, offerArpuUsd: 0.50,
    earnerShare: 0.30, coveredShare: 0.60, payerPepmUsd: 8.00,
    churnCeiling: 0.18, prizeMultiplier: 2.2,
